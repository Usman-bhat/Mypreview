...
exports.serializeSelectionContext = serializeSelectionContext;
function stableSortKeys(value) {
    ...
    if (value && typeof value === "object") {
        return Object.keys(value)
            ...
            accumulator[key] = stableSortKeys(value[key]);
            return accumulator;
        }, {});
    }
    return value;
}
function serializeSelectionContext(references) {
...
//# sourceMappingURL=contextExport.js.map